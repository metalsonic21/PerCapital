...
export const i18n = new Vuel18n({
    ...
    messages:{
        ...
        en:{
            ...
            mutuall: 'I.U.V',
            goal: 'OVERVIEW',
            goaldesc: 'The PER CAPITAL fund Mutual Fund for Open Capital Investment aims to produce medium and long-term capital growth. It mainly invests in shares of companies that are listed, traded and incorporated into the Caracas Stock Exchange, do business and are domiciled in Venezuela, as well as in corporate debt securities. Investments may be direct or indirect and the price of the Investment units may vary due to price movements of the securities that make up the portfolio.',
            info: 'KEY FACTS',
            info1: 'Launch Date',
            info2: 'Comparativo',
