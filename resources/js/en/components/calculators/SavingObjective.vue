...
<div>
    <div class="container">
        <h5 class="title-mine">Saving Goal</h5>
        <b-form>
            <b-form-group>
                <b-row>
                    <b-col cols="6">
                    ...
                    <b-col cols="6">
                        ...
                        <b-form-invalid-feedback :state="validationI">Data must be a positive number</b-form-invalid-feedback>
                ...
                <b-row>
                    <b-col cols="6">
                        ...
                        <b-form-invalid-feedback :state="validationp">Select periodicity</b-form-invalid-feedback>
                  
                    </b-col>
                    <b-col cols="6">
                        <label>Years</label>
                        <b-form-input type="text" v-model="n" :state="validationn"></b-form-input>
                        <b-form-invalid-feedback :state="validationn">Data must be numeric, greater than zero</b-form-invalid-feedback>
