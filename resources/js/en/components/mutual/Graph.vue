        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="title-mine section-title-per" align="center"> <strong>DISTRIBUTION BY SECTOR</strong></h1>
                ...
                <div class="row align-items-start ">
                    ...
                    <!--<div class="col-md-6">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td style="background-color:#4472c4"></td>
                                    <td>Estatal</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="background-color:#ed7d31"></td>
                                    <td>Industrial</td>
                                </tr>
                                ...
                                <tr>
                                    <td style="background-color:#264478"></td>
                                    <td>Agropecuario</td>
                                </tr>

                                <tr>
                                    <td style="background-color:#9e480e"></td>
                                    <td>Otros</td>
                                </tr>

                                <tr>
                                    <td style="background-color:#70AD47"></td>
                                    <td>Varios</td>
                                </tr>
