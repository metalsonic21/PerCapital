        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="title-mine title-placed section-title-per">SERVICES</h1>
                </div>
            </div>
                    ...
                    <div id="vertical-timeline" class="vertical-container light-timeline center-orientation">
                        <div class="vertical-timeline-block">
                            ...
                            <div class="vertical-timeline-content">
                                ...
                                <p>
                                    <ul>
                                        <li>Structuring of Funds and E.I.C.</li>
                                        <li>Fund and E.I.C. management</li>
                                    </ul>
                                </p>
                            ...
                            <div class="vertical-timeline-content">
                                ...
                                <p>Our work methodology consists of 4 steps:
                                    <ul>
                                        ...
                                        <li>Post registration activities</li>
                                        <li>Placement</li>
                                    </ul>
                                </p>
                            ...
                            <div class="vertical-timeline-content">
                                ...
                                <p>We offer financial solutions for corporate clients, institutional and high-income individuals such as:
                                    ...
                                    <ul>
                                        ...
                                        <li>Design and placement of structured products</li>
                                        <li>(Re) Corporate structuring</li>
                                        <li>Customize financial solutions for corporate clients</li>
