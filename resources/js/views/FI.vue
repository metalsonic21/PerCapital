            ...
            <div class="col-lg-6">
                ...
                <b-list-group>
                    ...
                    <b-list-group-item class="d-flex justify-content-between align-items-center">
                        ...
                        <b-badge variant="dark">Inmobiliario vivienda</b-badge>
                    </b-list-group-item>
                    <b-list-group-item class="d-flex justify-content-between align-items-center">
                    ...
                    <b-list-group-item class="d-flex justify-content-between align-items-center">
                        ...
                        <b-badge variant="dark">Bs 100.000,00</b-badge>
                    </b-list-group-item>
                </b-list-group>
            ...
            <div class="row" id="big-row">
                <div class="col-lg-6" id="risks-col">
                    ...
                    <div class="row" id="bubbles-row">
                        ...
                        <div class="col-lg-6">
                            <div class="bubble">
                                La culminación del proyecto puede verse afectada por desastres naturales o variables fuera del control de la Administradora de Fondos y el ejecutor de la obra.
                            </div>
                            <div class="comments-avatar">
                                <a href="" class="float-left">
                ...
                <div class="col-lg-6" id="invest-col">
                    ...
                    <div class="invest-items-bg">
                        ...
                        <p class="text-justify invest-last invest-p text-dark">
                            Invertir es ahora sencillo con PER CAPITAL, solo siga los siguientes pasos y empiece a sembrar su futuro ahora.
                        </p>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p class="text-justify invest-last invest-p text-dark">Seleccione el plazo deseado para su inversión (corto, mediano o largo)</p>
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p class="text-justify invest-last invest-p text-dark">Seleccione el fondo de su preferencia que se ajuste más a sus objetivos</p>
                                <br>
                            </div>
                        </div>
                        <div class="row">
