        ...
        <div class=row>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class=row>
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-xs" style="height:230px;">
                            <div class=box-icon><i class="fa fa-folder"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Introducción</h5>
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-big" style="height:1130px;">
                            <div class=box-icon><i class="fa fa-users"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Rol y responsabilidades de la Junta</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-aux" style="height:1130px;">
                            <div class=box-icon><i class="fa fa-check"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Calificaciones del director</h5>
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-md" style="height:580px;">
                            <div class=box-icon><i class="fa fa-list"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Responsabilidades del director</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-md" style="height:580px;">
                            ...
                            <div class=box-content>
                                <h5 class="gov-title">Liderazgo de la Junta</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-big" style="height:780px;">
                            <div class=box-icon><i class="fa fa-bullhorn"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Comités de la Junta</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box" style="height:780px;">
                            <div class=box-icon><i class="fa fa-edit"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Acceso del director a funcionarios, empleados y asesores independientes</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-sm" style="height:440px;">
                            ...
                            <div class=box-content>
                                <h5 class="gov-title">Compensación del director</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-sm" style="height:500px;">
                            <div class=box-icon><i class="fa fa-folder-open" ></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Orientación del Director y Educación Continua</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-sm" style="height:500px;">
                            <div class=box-icon><i class="fa fa-paperclip"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Evaluación del CEO y sucesión gerencial</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box">
                            <div class=box-icon><i class="fa fa-paste"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Evaluación anual de desempeño</h5>
                                <p class="gov-text text-justify">
