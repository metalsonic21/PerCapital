    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="navy-line" style="margin-top:-1px;"></div>
                <h1 class="title-mine text-center">CÓDIGO DE CONDUCTA Y ÉTICA EMPRESARIAL</h1>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box" style="height:350px;">
                            <div class="box-icon"><i class="fa fa-file"></i></div>
                            <div class="box-content">
                                <h5 class="gov-title">Documentos</h5>
                                <p class="gov-text">Guía de Gobierno Corporativo</p>
                                <small>Pautas de gobierno corporativo 2019</small>
                                <div class="center">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-sm" style="height:350px;">
                            <div class=box-icon><i class="fa fa-balance-scale"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Cumplimiento de leyes y reglamentos</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-big" style="height:830px;">
                            <div class=box-icon><i class="fa fa-users"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Conflictos de intereses</h5>
                                <p class="gov-text text-justify">
                                    ...
                                    <ul>
                                        <li>Actuar únicamente en el mejor interés de los clientes</li>
                                        <li>Mantener los altos estándares éticos y profesionales de PER CAPITAL</li>
                                        <li>Identificar, informar y gestionar conflictos de intereses reales, aparentes o potenciales</li>
                                        <li>Haga una divulgación completa y justa de cualquier conflicto de intereses, según sea necesario.</li>
                                    </ul>
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-big" style="height:830px;">
                            <div class=box-icon><i class="fa fa-key"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Uso de información privilegiada y comercio personal</h5>
                                <p class="gov-text text-justify">Las calificaciones mínimas para servir como miembro de la Junta Directiva (cada miembro de la Junta, un "Director") de PER CAPITAL son que una persona demuestre, por logros significativos en su campo, la capacidad de hacer una contribución significativa a La supervisión de la Junta de los negocios y asuntos de PER CAPITAL y el hecho de que una persona tenga un historial impecable y una reputación de conducta honesta y ética tanto en sus actividades profesionales como personales.
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-md" style="height:500px;">
                            <div class=box-icon><i class="fa fa-gift"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Regalos y entretenimiento</h5>
                                <p class="gov-text text-justify">
                                    ...
                                    <ul>
                                        <li>No es solicitado</li>
                                        <li>No es un regalo en efectivo</li>
                                        <li>Es consistente con las prácticas comerciales habituales</li>
                                        <li>No tiene un valor excesivo</li>
                                        <li>No puede interpretarse como un soborno o pago</li>
                                        <li>Se entrega o acepta sin compromiso</li>
                                        <li>No tiene la intención de solicitar o retener negocios o una ventaja en la conducción de los negocios</li>
                                        <li>No viola las leyes o regulaciones aplicables</li>
                                    </ul>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-sm" style="height:500px;">
                            <div class=box-icon><i class="fa fa-archive"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Oportunidades corporativas</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-md" style="height:550px;">
                            <div class=box-icon><i class="fa fa-users"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Competencia y trato justo</h5>
                                <p class="gov-text text-justify">
                                    ...
                                    <ul>
                                        <li>Apropiación indebida de información propietaria</li>
                                        <li>Poseer información de secreto comercial obtenida sin el consentimiento del propietario</li>
                                        <li>Inducir la divulgación de información de propiedad o información de secreto comercial por parte de empleados pasados o presentes de otras compañías</li>
                                        <li>Aprovecharse injustamente de cualquier persona mediante la manipulación, ocultamiento, abuso de información privilegiada, tergiversación de hechos materiales o cualquier otra práctica intencional de trato injusto.</li>
                                    </ul>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box" style="height:550px;">
                            <div class=box-icon><i class="fa fa-edit"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Confidencialidad</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-sm" style="height:440px;">
                            <div class=box-icon><i class="fa fa-check"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Informar cualquier comportamiento ilegal o poco ético</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box service-box-xs" style="height:440px;">
                            <div class=box-icon><i class="fa fa-money"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Protección y uso adecuado de los activos de PER CAPITAL</h5>
                                <p class="gov-text text-justify">
                    ...
                    <div class="col-xs-12 col-md-6 col-sm-12">
                        <div class="clearfix service-box">
                            <div class=box-icon><i class="fa fa-flag"></i></div>
                            <div class=box-content>
                                <h5 class="gov-title">Contribuciones políticas</h5>
                                <p class="gov-text text-justify">
